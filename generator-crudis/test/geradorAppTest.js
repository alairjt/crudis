(function () {
    ...
    var promptFluxoSimples = {"crudName":"CrudTest","menu":"Consulta","servico":"banco","recurso":"bancos","tipoVisualizacao":"Simples","nome":"field","label":"Field label","tipo":"String","telas":["consulta","formulario"],"adicionarOutro":false,"finalizar":true};
    ...
    describe('crudis:app', function () {
        before(function (done) {
            ...
            helpers.run(path.join(__dirname, '../generators/app'))
                ...
                .withPrompts(promptFluxoSimples)
                .on('end', done);
        });
